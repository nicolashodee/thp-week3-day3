...
def afficher(journalist)
  print journalist
end
=begin
def tweet(journalist)
  login_twitter.update('Bonjour journalist :)! Bon boulot. #bonjour_monde')
end
=end
# login_twitter.update('Mon troisieme tweet en Ruby !!!!')
...
three_journalists=journalists.sample(10)

=begin

3.times {
  login_twitter.update("Bonjour #{three_journalists.sample} ! Bon boulot. #bonjour_monde")
}

=end

=begin
login_twitter.search('#Alpes', result_type: "recent").take(3).each do |tweet|
